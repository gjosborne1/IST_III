    ...
    match inp:
        case "bet":
            ...
            while inp!="1" and inp!="2" and inp!="3" and inp!="n":
                inp = input("Type \"1\" to bet on row 1, \"2\" to bet on row 2, or \"3\" to bet on row 3\n").lower()
                match inp:
                    case "1":
                        row1=True
                    case "2":
            ...
            while inp!="1" and inp!="2" and inp!="n":
                inp=input("Type \"1\" to bet on half 1 or \"2\" to bet on half 2\n").lower()
                match inp:
                    case "1":
                        half1=True
                    case "2":
            ...
            inp=None
            while inp!="1" and inp!="2" and inp!="3" and inp!="n":
                inp = input("Type \"1\" to bet on third 1, \"2\" to bet on third 2, or \"3\" to bet on third 3\n").lower()
                match inp:
                    case "1":
                        third1=True
                    case "2":
...
Row: Bet on the entire first, second, or third horizontal row on the table, 2 to 1 payout
Half: Bet on the entire first or second vertical half of the table, 1 to 1 payout
Dozen: Bet on the entire first, second, or third vertical third of the table, 2 to 1 payout
Straight up: Bet on one number on the table, 36 to 1 payout. Multiple numbers can be bet on at the same time

The table layout is as follows:
3r  6b  9r  12r  15b  18r  21r  24b  27r  30r  33b  36r   row 3
2b  5r  8b  11b  14r  17b  20b  23r  26b  29b  32r  35b   row 2
1r  4b  7r  10b  13b  16r  19r  22b  25r  28b  31b  34r   row 1
...
---""")
    ...
    print("Type \"bet\" to continue playing, \"balance\" to view current balance, \"help\" for info on betting, or \"quit\" to quit")